...
def find_isomorphic_graph(original_graph: nx.Graph, left_side_graph: nx.Graph, selector=lambda x, _: x[0]) -> dict:
    isomorphic_g = []
    ...
    try:
        return selector(isomorphic_g, original_graph)
...
def is_almost_equal(a, b, epsilon=0.0001):
