...
from utils import find_isomorphic_graph, update_graph, find_isomorphic_graph_p7_p8
...
def merge_nodes(unique_id: int, mapping: dict, graph: nx.Graph):
    ...
    for nodes_to_join in nodes_to_join_list:
        ...
        same_pos = left_node["x"] == right_node["x"] and left_node["y"] == right_node["y"] and left_node["level"] == \
                   right_node["level"]
