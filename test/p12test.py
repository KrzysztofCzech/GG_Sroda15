...
class P12Test(unittest.TestCase):
    def test_production_is_applied(self):
        ...
        draw_graph(graph, name='prod12_1-test_0', level_offset=150)

        result = p12(graph, 1)
        draw_graph(graph, name='prod12_1-test_1', level_offset=150)
    ...
    def test_as_subgraph_is_applied(self):
        ...
        graph.add_nodes_from([
            ...
            Node(9, label='I', x=90, y=0, level=2).graph_adapter(),
            # More added
            Node(10, label='E', x=40, y=250, level=2).graph_adapter(),
            Node(11, label='E', x=80, y=220, level=2).graph_adapter(),
            Node(12, label='E', x=200, y=0, level=2).graph_adapter(),
            Node(13, label='E', x=400, y=45, level=2).graph_adapter(),
        ])
        graph.add_edges_from([
            (0, 1),
            (1, 2),
        ...
        draw_graph(graph, name='prod12_2-test_0', level_offset=150)

        result = p12(graph, 1)
        draw_graph(graph, name='prod12_2-test_1', level_offset=150)
        ...
        expected_nodes = {
            ...
            6: {'label': 'I', 'level': 2, 'x': 0, 'y': 90},
            9: {'label': 'I', 'level': 2, 'x': 90, 'y': 0},
            10: {'label': 'E', 'level': 2, 'x': 40, 'y': 250},
            11: {'label': 'E', 'level': 2, 'x': 80, 'y': 220},
            12: {'label': 'E', 'level': 2, 'x': 200, 'y': 0},
            13: {'label': 'E', 'level': 2, 'x': 400, 'y': 45},
        }

        self.assertEqual(expected_nodes, graph._node)

        expected_edges = [
            (0, 1), (0, 2), (0, 3), (1, 2), (1, 3), (2, 6), (3, 9), (4, 5), (4, 6),
            (4, 11), (4, 9), (5, 6), (5, 13),
            (5, 9), (9, 10), (9, 12), (9, 13), (12, 13)
        ]
    ...
    def test_without_one_node_removed(self):
        ...
        draw_graph(graph, name='prod12_3-test_0', level_offset=150)

        result = p12(graph, 1)
        draw_graph(graph, name='prod12_3-test_1', level_offset=150)
