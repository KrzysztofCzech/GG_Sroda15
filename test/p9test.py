...
class P9Test(unittest.TestCase):
    def test_P9(self):
        ...
        self.assertEqual(graph._node, {0: {'label': 'I', 'x': 0.5, 'y': 0.5, 'level': 0}, 1: {'label': 'E', 'x': 0.0, 'y': 1.0, 'level': 0}, 2: {'label': 'E', 'x': 0.0, 'y': 0.0, 'level': 0}, 3: {'label': 'E', 'x': 1.0, 'y': 0.0, 'level': 0}, 4: {'label': 'I', 'x': 0.3333333333333333, 'y': 0.3333333333333333, 'level': 1}, 5: {'label': 'E', 'x': 0.0, 'y': 1.0, 'level': 1}, 6: {'label': 'E', 'x': 0.0, 'y': 0.0, 'level': 1}, 7: {'label': 'E', 'x': 1.0, 'y': 0.0, 'level': 1}})
